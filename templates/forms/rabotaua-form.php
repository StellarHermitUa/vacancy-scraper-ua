<?php
/**
 * Template for Rabota.ua company form.
 *
...
if (empty($company_id)) : ?>
    <input type="text" name="vacancy_scraper_ua_rabotaua_company_id" class="company_id_field">
    <p><em><?php esc_html_e('Enter Robota.ua company ID(123456) or URL(https://robota.ua/company123456) and click Save.', 'vacancy-scraper-ua'); ?></em></p>
...
<?php else : ?>
    ...
    <button type="submit" name="vacancy_scraper_ua_action" value="delete_rabotaua" class="button button-secondary">
        <?php esc_html_e('Delete', 'vacancy-scraper-ua'); ?>
    </button>
    <button type="submit" name="vacancy_scraper_ua_action" value="fetch_rabotaua" class="button button-primary">
    ...
    <div class="jv_additional">
        ...
        <div class="jv-theme">
            <label>
                ...
                <input type="checkbox" name="vacancy_scraper_ua_rabotaua_filter" value="1" <?php echo $rabotaua_company_options['filter']? 'checked':'';?>>
            </label> 
        ...
        <div class="jv-theme">
            <label>
                ...
                <input type="color" name="vacancy_scraper_ua_rabotaua_colors[jv-background]" value="<?php echo esc_html($rabotaua_company_options['colors']['jv-background'] ?? '#ffffff');?>">
            </label>
            <label>
                <?php esc_html_e('Title Color', 'vacancy-scraper-ua'); ?>:
                <input type="color" name="vacancy_scraper_ua_rabotaua_colors[jv-title]" value="<?php echo esc_html($rabotaua_company_options['colors']['jv-title'] ?? '#000000');?>">
            </label>
            <label>
                <?php esc_html_e('City Color', 'vacancy-scraper-ua'); ?>:
                <input type="color" name="vacancy_scraper_ua_rabotaua_colors[jv-city]" value="<?php echo esc_html($rabotaua_company_options['colors']['jv-city'] ?? '#cccccc');?>">
            </label>
            <label>
                <?php esc_html_e('Salary Color', 'vacancy-scraper-ua'); ?>:
                <input type="color" name="vacancy_scraper_ua_rabotaua_colors[jv-salary]" value="<?php echo esc_html($rabotaua_company_options['colors']['jv-salary'] ?? '#98a1a4');?>">
            </label>
            <label>
                <?php esc_html_e('Button Color', 'vacancy-scraper-ua'); ?>:
                <input type="color" name="vacancy_scraper_ua_rabotaua_colors[jv-button]" value="<?php echo esc_html($rabotaua_company_options['colors']['jv-button'] ?? '#000000');?>">
            </label>            
            <label>
                <?php esc_html_e('Button Color', 'vacancy-scraper-ua'); ?> (hover):
                <input type="color" name="vacancy_scraper_ua_rabotaua_colors[jv-button-hover]" value="<?php echo esc_html($rabotaua_company_options['colors']['jv-button-hover'] ?? '#98a1a4');?>">
            </label>            
        </div>
        ...
        <button type="submit" name="vacancy_scraper_ua_action" value="save_rabotaua_options" class="button button-primary">
